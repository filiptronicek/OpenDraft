...
import OidcCallbackRoute from './components/OidcCallbackRoute';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/auth/oidc/callback" element={<OidcCallbackRoute />} />
        ...
        <Route path="/collab" element={<ScreenplayEditor />} />
